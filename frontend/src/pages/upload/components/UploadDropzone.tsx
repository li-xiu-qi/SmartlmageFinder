...
// 注意：此组件只负责文件选择和拖拽上传功能，不显示文件列表
// 文件列表的显示由单独的 FileListView 组件负责
const UploadDropzone: React.FC<UploadDropzoneProps> = ({ fileList, onChange, onRemove, disabled }) => {// 配置 Ant Design Upload 组件的 props
  const props: UploadProps = {
    ...
    showUploadList: false, // 禁用内置的文件列表显示，使用自定义的 FileListView 组件

...
from .extensions.loader import setup_connection
...
def initialize_connection_pool(database_path: str, max_connections: int = 10) -> DatabaseConnectionPool:
    """初始化连接池"""

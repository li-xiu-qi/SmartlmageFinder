...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card p-6 shadow-lg transition ease-in-out data-[state=open]:animate-slide-up",
  {
    variants: {
      side: {
        top: "inset-x-0 top-0 border-b",
        bottom: "inset-x-0 bottom-0 border-t",
        left: "inset-y-0 left-0 h-full w-3/4 border-r max-w-md",
        right: "inset-y-0 right-0 h-full w-3/4 border-l max-w-xl data-[state=open]:animate-slide-up",
      },
    },
    defaultVariants: {
      side: "right",
